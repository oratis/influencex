  ...
  render() {
    ...
    return (
      <div className="error-boundary-fallback" role="alert">
        <div className="error-card" style={{ maxWidth: 520, margin: '80px auto', padding: 24, border: '1px solid var(--border)', borderRadius: 12, background: 'var(--bg-card)' }}>
          ...
          {this.state.error?.message && (
            <pre style={{ background: 'var(--bg-input)', padding: 8, borderRadius: 6, fontSize: 12, overflow: 'auto', maxHeight: 120, margin: 0, marginBottom: 16 }}>
